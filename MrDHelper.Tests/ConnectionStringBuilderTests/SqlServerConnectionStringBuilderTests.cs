...
namespace MrDHelper.Tests
{
    public class SqlServerConnectionStringBuilderTests
    {
        ...
        [TestCase(@"190.190.200.100,1433", "myDataBase", "myUsername", "myPassword", false,true, "Data Source=190.190.200.100,1433;Initial Catalog=myDataBase;Integrated Security=False;User Id=myUsername;Password=myPassword;")]
